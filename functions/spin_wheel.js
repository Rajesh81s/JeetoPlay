...
const DEFAULT_SEGMENTS = [
    ...
    { label: '🪙 2', prize: 2, weight: 25, type: 'CASH' },
    { label: 'Better Luck', prize: 0, weight: 20, type: 'NONE' },
    { label: '🪙 3', prize: 3, weight: 12, type: 'CASH' },
    { label: '🪙 5', prize: 5, weight: 7, type: 'CASH' },
    { label: '+1 Spin', prize: 1, weight: 3, type: 'SPIN' },
    { label: '🪙 10', prize: 10, weight: 2, type: 'CASH' },
    { label: '🪙 25 Jackpot', prize: 25, weight: 1, type: 'CASH' }
];
