...
const ludoAI = require('./ludo-ai');
const otp = require('./otp');
const earnAds = require('./earn_ads');
...
// Ludo AI — In-App (2 exports)
exports.startLudoAIMatch = ludoAI.startLudoAIMatch;
exports.completeLudoAIMatch = ludoAI.completeLudoAIMatch;

// Ludo PvP — Real-Time Multiplayer (2 exports)
const ludoPvP = require('./ludo-pvp');
exports.startLudoPvPMatch = ludoPvP.startLudoPvPMatch;
exports.completeLudoPvPMatch = ludoPvP.completeLudoPvPMatch;
...
exports.sendTournamentLobbyCredsPush = notifications.sendTournamentLobbyCredsPush;
...
exports.autoExpireEmptyEsportsMatches = scheduled.autoExpireEmptyEsportsMatches;

// Smart Notification Engine (1 export — automated engagement notifications)
const smartNotifications = require('./smart_notifications');
exports.smartNotificationEngine = smartNotifications.smartNotificationEngine;

// Tournament (3 exports — no unregister, joining is final)
exports.registerForTournament = tournament.registerForTournament;
exports.completeBracketTournament = tournament.completeBracketTournament;
exports.completeLobbyTournament = tournament.completeLobbyTournament;

// OTP Authentication (1 export — MSG91 Widget handles sending, we only verify)
exports.verifyOTP = otp.verifyOTP;

// Earn Ads / Watch & Earn (1 export)
exports.claimAdReward = earnAds.claimAdReward;

// Telegram Support Bot (1 export)
